...
user_almir.save!
  ...
  male_shirt =  Shirt.new(team: "Real Madrid", gender:'Male' , size:'G', price: Faker::Number.decimal(l_digits: 2, r_digits: 2))
  ...
  female_shirt = Shirt.new(team: " AC Milan", gender:'Female' , size:'M', price: Faker::Number.decimal(l_digits: 2, r_digits: 2))
  ...
  male_shirt =  Shirt.new(team: "Corinthians", gender:'Male' , size:'G', price: Faker::Number.decimal(l_digits: 2, r_digits: 2))
  male_shirt.user = user_almir
  ...
  female_shirt = Shirt.new(team: "Paris Saint-German", gender:'Female' , size:'M', price: Faker::Number.decimal(l_digits: 2, r_digits: 2))
  female_shirt.user = user_almir
  ...
  male_shirt =  Shirt.new(team: "São Paulo", gender:'Male' , size:'G', price: Faker::Number.decimal(l_digits: 2, r_digits: 2))
  male_shirt.user = user_almir
  ...
  male_shirt =  Shirt.new(team: "Bayern Munchen", gender:'Male' , size:'G', price: Faker::Number.decimal(l_digits: 2, r_digits: 2))
  male_shirt.user = user_almir
